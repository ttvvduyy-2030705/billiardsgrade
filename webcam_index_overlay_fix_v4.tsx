  ...
  ({
    ...
    const scoreboard = (
      <PoolBroadcastScoreboard
        ...
        bottomOffset={fullscreenMode ? 18 : compactMode ? 26 : 12}
      />
    );
    ...
    return (
      <RNView pointerEvents="none" style={styles.scoreboardCompactOverlay}>
  ...
  ({
    ...
    const scoreboard = (
      <CaromBroadcastScoreboard
        ...
        playerSettings={state.playerSettings}
        variant={fullscreenMode ? 'fullscreen' : 'camera'}
        bottomOffset={fullscreenMode ? 18 : compactMode ? -18 : -32}
      />
    );
