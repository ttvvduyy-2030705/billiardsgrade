...
const GamePlayer = (
  ...
  const addTimeButtonDynamicStyle = isLightPlayerPanel
    ? styles.addTimeButtonOnLightPanel
    : undefined;
  const addTimeTextColorStyle = {
    color: isLightPlayerPanel ? '#111111' : '#FFFFFF',
  };
