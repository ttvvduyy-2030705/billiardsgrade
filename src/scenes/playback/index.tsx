...
import {buildReplayFolderPath, resolveReplayFolder} from 'services/replay/localReplay';
...
const PlayBackWebcam = (props: PlayBackWebcamViewModelProps) => {
  ...
  const [folder, setFolder] = useState<string>(buildReplayFolderPath(props.webcamFolderName));
