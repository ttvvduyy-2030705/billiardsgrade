  ...
  return (
    <Stack.Navigator initialRouteName={screens.home}>
      ...
      <Stack.Screen
        ...
        options={buildCustomTitleOptions('Chọn nền tảng livestream')}
      />

      <Stack.Screen
        name={screens.livePlatformSetup}
        getComponent={getWrappedLivePlatformSetup}
        options={buildCustomTitleOptions('Thiết lập livestream')}
      />
      ...
      <Stack.Screen
        ...
        options={buildOptions(screens.history)}
      />
      ...
      <Stack.Screen
        ...
        options={buildOptions(screens.configs)}
      />
    </Stack.Navigator>
  );
};
