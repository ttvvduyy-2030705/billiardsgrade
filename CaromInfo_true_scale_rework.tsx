...
const CaromInfo = (props: Props) => {
  ...
  const scale = isHandheldLandscape
    ? clamp(profile.consoleScale * 0.82, 0.5, 0.68)
    : useUltraCondensed
    ? 0.7
    : useCondensed
    ? 0.82
        ...
        <View
          ...
          <View flex={'1'} direction={'row'}>
            <Countdown
              ...
              countdownWidth={Math.min(dims.screenWidth * (isHandheldLandscape ? 0.15 : useUltraCondensed ? 0.2 : useCondensed ? 0.23 : 0.28), isHandheldLandscape ? 165 : useUltraCondensed ? 240 : useCondensed ? 280 : 360)}
              heightItem={isHandheldLandscape ? 10 : useUltraCondensed ? 16 : useCondensed ? 20 : 27}
