  ...
  ({
    ...
    return (
      <PoolBroadcastScoreboard
        ...
        style={compactMode ? styles.poolScoreboardCompact : undefined}
      />
    );
  },
);
  ...
  ({
    ...
    return (
      <CaromBroadcastScoreboard
        ...
        playerSettings={state.playerSettings}
        variant={fullscreenMode ? 'fullscreen' : 'camera'}
        bottomOffset={fullscreenMode ? 18 : compactMode ? -40 : -32}
        style={compactMode ? styles.caromScoreboardCompact : undefined}
      />
    );
  },
);
...
const WebCam = forwardRef<WebCamHandle, WebCamComponentProps>((props, ref) => {
  ...
  const renderOverlay = (fullscreenMode = false) => {
    ...
    const compactMode = !fullscreenMode && isHandheldLandscape;
        ...
        {imageUris.map((uri, index) => (
          <RNImage
            ...
            style={[
              ...
              !fullscreenMode && isHandheldLandscape && styles.thumbnailImageCompact,
