  ...
  ({
    ...
    const scoreboard = (
      <PoolBroadcastScoreboard
        ...
        bottomOffset={fullscreenMode ? 12 : compactMode ? 3 : 10}
      />
    );

    if (fullscreenMode) {
      return (
        <RNView pointerEvents="none" style={styles.poolScoreboardFullscreenOverlay}>
          <RNView style={styles.poolScoreboardFullscreenScale}>{scoreboard}</RNView>
        </RNView>
      );
    }
...
const styles = StyleSheet.create({
  ...
  poolScoreboardFullscreenOverlay: {
    ...StyleSheet.absoluteFillObject,
    justifyContent: 'flex-end',
    alignItems: 'center',
    paddingBottom: 10,
  ...
  poolScoreboardCompactScale: {
    transform: [{scaleX: 0.62}, {scaleY: 0.46}],
  },

  poolScoreboardFullscreenScale: {
